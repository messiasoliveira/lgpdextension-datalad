...
class TestParquet(unittest.TestCase):
    def __init__(self,*args,**kwargs):
        ...
        self.settings_w_names = {"file":{"format":"parquet","separator":"","names":["Name", "Age"],"header":"None","path":f"{Folder().getcurrent()}/datalad_helloworld/tests/resources/test_exists.parquet"}}
        self.settings = {"file":{"format":"parquet","separator":"","names":[],"header":"None","path":f"{Folder().getcurrent()}/datalad_helloworld/tests/resources/test_exists.parquet"}}
